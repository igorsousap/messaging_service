defmodule MessagingService.Persistence.Accounts.UserToken do
  use Ecto.Schema
  import Ecto.Query
  alias MessagingService.Persistence.Accounts.UserToken
  ...
  def build_insert_session_token(user_id, token) do
