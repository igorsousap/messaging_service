defmodule MessagingServiceWeb.Router do
  ...
  import MessagingServiceWeb.UserAuth
  ...
  scope "/", MessagingServiceWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{MessagingServiceWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", MessagingServiceWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{MessagingServiceWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", MessagingServiceWeb do
    ...
    live_session :current_user,
      on_mount: [{MessagingServiceWeb.UserAuth, :mount_current_user}] do
