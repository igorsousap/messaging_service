defmodule MessagingServiceWeb.PromEx do
  @moduledoc """
  ...
  3. Update your `endpoint.ex` file to expose your metrics (or configure a standalone
     ...
     ```
     defmodule MessagingServiceWebWeb.Endpoint do
       use Phoenix.Endpoint, otp_app: :messaging_service_web
  ...
  use PromEx, otp_app: :messaging_service_web
  ...
  def dashboards do
    [
      ...
      # {:messaging_service_web, "/grafana_dashboards/user_metrics.json"}
    ]
  end
end
